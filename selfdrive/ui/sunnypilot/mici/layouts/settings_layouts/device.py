...
class DeviceLayoutMiciSP(DeviceLayoutMici):
  def __init__(self, back_callback: Callable):
    ...
    self._enable_offroad = BigCircleButton("icons_mici/settings/device/always_offroad.png",
                                                      red=True, icon_size=(120, 120))
    self._enable_offroad.set_click_callback(self._handle_always_offroad)

    self._disable_offroad = BigCircleButton("icons_mici/settings/device/disable_offroad.png",
  ...
  def _handle_always_offroad(self):
    ...
    if ui_state.params.get_bool("OffroadMode"):
      ...
      dlg = BigConfirmationDialogV2(tr("slide for always offroad"), "icons_mici/settings/device/lkas.png",

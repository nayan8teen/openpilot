...
QT_MOC_LITERAL(4, 37, 21) // "disabledButtonClicked"

    },
    "ButtonParamControl\0buttonClicked\0\0id\0"
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ButtonParamControl *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ButtonParamControl::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ButtonParamControl::buttonClicked)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ButtonParamControl::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ButtonParamControl::disabledButtonClicked)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void ButtonParamControl::buttonClicked(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
    QMetaObject::activate(this, &staticMetaObject, 0, _a);
}
...
// SIGNAL 1
void ButtonParamControl::disabledButtonClicked(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };

...
A_CRUISE_MAX_VALS =   [2.0, 2.0,  2.0,  1.99,  1.24, .75,  .66, .44,  .333,  .115]
A_CRUISE_MAX_BP =     [0.,  1.,   6.,   8.,   11.,  16.,   20.,  25.,  30.,  55.]
A_CRUISE_MIN_VALS =    [-0.10, -0.10, -0.15, -0.15, -1.0,  -1.0,  -1.2, -1.2,  -1.2]
A_CRUISE_MIN_BP =      [0.,    8.,    8.01,  13.,   13.01, 18.,   18.01,  25.,  30.]
